<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageIndex.master" AutoEventWireup="true" CodeFile="ucuslar.aspx.cs" Inherits="ucuslar" %>
            ...
            <ItemTemplate>
                ...
                <div class="vitrin_ilan">
                    ...
                    <div class="ilan_resim">
                        <img src="images/hotelresim/<%#DataBinder.Eval(Container.DataItem, "f_resim") %>" height="150" width="160" />
                    </div>
